...
import top.glory.common.exception.GloryFastException;
...
public class JwtUtil {
     ...
     * @throws Exception
     */
    public static String getUserNameByToken(HttpServletRequest request) throws GloryFastException {
        String accessToken = request.getHeader("X-Access-Token");
        String username = getUsername(accessToken);
        if (StringUtil.isEmpty(username)) {
            throw new GloryFastException("未获取到用户");
        }
        return username;
    }

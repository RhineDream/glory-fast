...
//                System.out.println("\t\t有" + (linenumber - yuan) + "行");
    ...
    public static void main(String args[]) {
        ...
        list.add("/glory-common");
        list.add("/glory-service-api");
        list.add("/glory-unit");
        list.add("/glory-web");
        int count = 0;
        for (String o : list) {
            LineCounter lc = new LineCounter();
            String projectName = o;     //这里传入你的项目名称
            int counter = lc.counter(projectName);
